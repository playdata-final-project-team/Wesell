...
const Withdraw = (props: Props) => {
    ...
    function pwCheckResponse(responseBody: ResponseDto | null){
        ...
        if(code === ResponseCode.NOT_FOUND_USER ||
        ...
        <div className='withdraw-wrapper'>
            <div className='withdraw-container'>
                ...
                (<div className='withdraw-content-pwCheck'>
                    ...
                    />
                    <button className='pw-check-request-btn' type='button'
                    onClick={onPwBtnClickHandler}>입력</button>
                </div>)}
                {view === 'confirm-msg' &&
                ...
                <button className='close-btn' title='close' type='button' 
                    onClick={onCloseBtnClickHandler} >닫기</button>
            </div>
        </div>
    );
}
